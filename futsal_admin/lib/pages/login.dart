...
import 'package:futsal_admin/pages/signup.dart';
...
class Login extends StatefulWidget {
  ...
  Login({super.key, required this.parentUpdateFunction});
  ...
  Future<void> handleLogin(BuildContext context) async {
    try {
      ...
      if (supabase.auth.currentSession != null) {
        if (supabase.auth.currentUser!.userMetadata!['admin'] == null) {
          setState(() {
            _errorMsg = "You are not a Admin";
          });
